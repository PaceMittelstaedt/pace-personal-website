---
title: "Livestock Judging"
---

::: {style="text-align:center;"}
<img src="./2023.jpg" id="slide" width="500px"/> <br> <button onclick="document.getElementById('slide').src = prevSlide()">← Prev</button> <button onclick="document.getElementById('slide').src = nextSlide()">Next →</button>
:::

```{=html}
<script type="text/javascript">
  var images = ["./2023.jpg", "./2024.jpg", "./2025.jpg"];
  var i = 0;
  function nextSlide() {
    i = (i + 1) % images.length;
    return images[i];
